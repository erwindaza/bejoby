...
export default function EmailSequencesAdmin() {
  ...
  useEffect(() => {
    const storedSecret = window.sessionStorage.getItem("bejoby_admin_secret") || "";
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white pt-20">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {!adminSecret && (
          <form onSubmit={handleSecretSubmit} className="bg-slate-800 border border-slate-700 rounded-xl p-6 mb-8 max-w-xl">
            <label className="block text-sm font-medium text-slate-300 mb-2" htmlFor="admin-secret">
              Admin secret
            </label>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:border-blue-500 outline-none"
                autoComplete="off"
              />
              <button
                type="submit"
